...
import { NotificationStack } from '../appFlow/ShopStack'
import { DashboardStack } from '../appFlow/dashboardStack'
import { ProgressStack } from '../appFlow/progressStack'
        ...
        <TouchableOpacity
            ...
            <View style={[styles.btn]}>
                <View style={{ alignItems: 'center' }}>
                    ...
                    <Image source={item.icon} style={[styles.tabIcon, { tintColor: focused ? colors.lightBackground : colors.lightBlack }]} />
                </View>
            </View>
        </TouchableOpacity>
    )
