          ...
          <View style={styles.box}>
              <View style={styles.txt}>
                <Text style={styles.left}>
                  Source : <Text style={styles.spanleft}>AMC</Text></Text> 
                  <View style={styles.spacer}>
                  <Text style={styles.right}>Difficulty:<Text style={styles.spanright}> 37.225</Text></Text>
                  </View>  
              </View>
              <View >
                    <Text style={styles.ptxt}>
                    Lorem ipsum dolor sit amet, adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. 
                    </Text>
                  </View>
            ...
            <View style={styles.boxx}>
              ...
              <View >
                    ...
                    Answer is 34,Lorem ipsum dolor sit amet, adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.  

                    </Text>
                  </View>
                  <View style={styles.pv30}>
            <Button onPress={() => navigation.navigate(routes.answer)}>SUBMIT</Button>
          </View>
